...
class HomeScreenCorporate extends StatefulWidget {
  const HomeScreenCorporate({super.key});

  @override
  State<HomeScreenCorporate> createState() => _HomeScreenCorporateState();
}

class _HomeScreenCorporateState extends State<HomeScreenCorporate> {

  bool flag = false;

  Future<void> _showDialog5(BuildContext context) async {
    await showDialog(
        context: context,
